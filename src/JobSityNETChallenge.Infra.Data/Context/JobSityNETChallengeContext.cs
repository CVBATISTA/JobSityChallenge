...
{
    public sealed class JobSityNETChallengeContext : IdentityDbContext, IUnitOfWork
    {
        private readonly IMediatorHandler _mediatorHandler;

        public JobSityNETChallengeContext(DbContextOptions<JobSityNETChallengeContext> options, IMediatorHandler mediatorHandler) : base(options)
        {
